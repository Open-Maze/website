    ...
    <div className="flex items-center justify-between border-b border-gray-400 py-8">
      ...
      <nav>
        <section className="MOBILE-MENU flex lg:hidden">
          <div className="HAMBURGER-ICON space-y-2" aria-hidden onClick={() => setIsNavOpen((prev) => !prev)}>
          ...
          <div className={isNavOpen ? 'showMenuNav' : 'hideMenuNav'}>
            <div className="absolute top-0 right-0 px-8 py-8" aria-hidden onClick={() => setIsNavOpen(false)}>
              <svg
