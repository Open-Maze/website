...
const ContactCard = ({ link, icon, title, content }) => (
  <a href={link} target="_blank" rel="noreferrer">
    <div className="contact-card-s-container flex min-w-full items-center justify-start rounded-3xl bg-bleach p-6 shadow-lg transition hover:cursor-pointer hover:bg-violet-darker hover:text-white">
      <div
